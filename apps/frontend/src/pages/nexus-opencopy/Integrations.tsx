...
export default function NexusOpenCopyIntegrations() {
  ...
  function getStatusIcon(status: string) {
    if (status === "connected") return <CheckCircle size={16} className="text-emerald-400" />;
    ...
    <div className="space-y-6">
              ...
              {integration.status === "connected" ? (
                <>
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-2 px-3 py-2 rounded-lg border border-slate-700 hover:bg-slate-800 text-sm transition-colors"
                  >
                    <Settings size={14} />
                    Configure
                  </button>
                  <button
                    ...
                    className="flex items-center justify-center gap-2 px-3 py-2 rounded-lg hover:bg-red-500/20 text-red-400 text-sm transition-colors"
                  >
                    Disconnect
                  </button>
                </>
      ...
      <div className="rounded-xl border border-slate-800 bg-slate-900/40 p-6">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="p-4 rounded-lg bg-slate-800/50">
            ...
            <code className="text-sm text-cyan-400">https://api.nexusopencopy.com/v1</code>
          </div>
          <div className="p-4 rounded-lg bg-slate-800/50">
      ...
      <div className="rounded-xl border border-slate-800 bg-slate-900/40 p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <button className="flex items-center gap-2 px-3 py-1.5 rounded-lg border border-slate-700 hover:bg-slate-800 text-sm">
            <Plus size={14} />
            Add Webhook
          </button>
        </div>
        ...
        <div className="rounded-lg border border-slate-700 p-4 text-center text-slate-500 text-sm">
