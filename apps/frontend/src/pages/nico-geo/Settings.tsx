        ...
        <div className="space-y-4 max-w-md">
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-2.5 rounded-xl border border-slate-200 bg-slate-100 text-white focus:outline-none focus:border-teal-500"
            >
          ...
          <div className="flex items-center justify-between py-3 border-t border-slate-200">
            ...
            <button
              ...
              className={`w-12 h-6 rounded-full transition-colors ${
                generalSettings.includeSchemaMarkup ? "bg-teal-500" : "bg-slate-200"
              }`}
            >
              <div
          ...
          <div className="flex items-center justify-between py-3 border-t border-slate-200">
            <div>
              <div className="font-medium text-sm flex items-center gap-2">
                ...
                <span className="px-2 py-0.5 rounded text-xs bg-emerald-500/20 text-emerald-600">Required</span>
              </div>
        ...
        <div className="space-y-4 max-w-md">
          ...
          <div className="flex items-center justify-between py-3 border-t border-slate-200">
            ...
            <button
              ...
              className={`w-12 h-6 rounded-full transition-colors ${
                apiSettings.enableRateLimiting ? "bg-blue-500" : "bg-slate-200"
              }`}
            >
              <div
                className={`w-5 h-5 rounded-full bg-white transition-transform ${
        ...
        <div className="space-y-4 max-w-md">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 rounded-xl border border-slate-200 bg-slate-100 text-white placeholder-slate-500 focus:outline-none focus:border-purple-500"
            />
          </div>
